...
- **Инструменты для файлов проекта**: открытие связанных файлов из сообщений и проверка Git Diff, предпросмотр исходного кода, Markdown, изображений, аудио, PDF и DOCX с автоматическим обновлением.
