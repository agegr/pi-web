...
This project is indexed by GitNexus as **omp-web** (2771 symbols, 7200 relationships, 232 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
