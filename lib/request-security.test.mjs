...
test("proxy keeps auth pages and auth APIs public", async () => {
  const { getRequestAccess } = await import("./request-security.ts");
  const publicPaths = ["/login", "/setup", "/api/auth/status", "/api/auth/login", "/_next/static/chunk.js", "/_next/image", "/favicon.ico"];
