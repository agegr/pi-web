...
test("keeps the responsive right panel default within useful limits", () => {
  ...
  assert.equal(getDefaultRightPanelWidth(1366), 464);
  assert.equal(getDefaultRightPanelWidth(1920), 640);
  assert.ok(1280 - 260 - getDefaultRightPanelWidth(1280) >= 560, "default desktop split leaves room for composer controls");
});
