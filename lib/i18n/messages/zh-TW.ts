...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.catalog": "模型目錄",
    "models.catalogEmpty": "該供應商目錄中沒有模型",
    "models.toggleHint": "切換該模型是否顯示在模型選擇器中",
    "models.backfillNotice": "已為新供應商自動保留全部模型（provider/*）：{providers}",
    "models.refreshCatalog": "重新整理模型",
    "models.refreshCatalogHint": "重新擷取遠端模型目錄（pi.dev）。pi-web 平時只讀本機快取。",
    "models.refreshing": "重新整理中…",
    "models.imageTag": "圖像",
    "models.supportsImage": "支援圖像輸入",
    "models.reasoningTag": "推理",
    "models.supportsReasoning": "支援擴充推理",
    "models.whitelistActive": "白名單已啟用：{count} 條模式",
    "models.whitelistInactive": "白名單未啟用：全部模型可見",
    "models.masterToggleHint": "批次開關該供應商的全部模型",
    ...
    "i18n.removeOAuthConfirm": "移除 {provider} 的連接？將刪除已保存的登入憑證，該供應商的模型將不可用，直至重新登入。",
    "i18n.deleteProviderConfirm": "刪除自定義供應商 {provider}？將同時刪除其模型定義與保存在其中的 API key，此操作不可恢復。",
    "i18n.deleteModelConfirm": "移除模型 {model}？",
    "i18n.removeKeyConfirm": "移除 {provider} 的 API key？該供應商的模型將不可用，直至重新填寫。",
