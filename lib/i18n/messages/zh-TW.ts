...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.backgroundDescription": "僅儲存在目前瀏覽器中，自動保留最近 20 張圖片。",
    "settings.backgroundChoose": "選擇圖片",
    "settings.backgroundSaving": "儲存中…",
    "settings.backgroundDisable": "關閉背景",
    "settings.backgroundOpacity": "圖片透明度",
    "settings.backgroundHistory": "近期背景",
    "settings.backgroundUse": "使用 {name} 作為背景",
    "settings.backgroundRemove": "刪除背景",
    "settings.backgroundRemoveNamed": "刪除 {name}",
