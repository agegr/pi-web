...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.openConversations": "開啟的對話",
    "chat.closeConversation": "關閉對話",
    "sidebar.new": "新增",
    ...
    "chat.voice": "語音輸入",
    "chat.voiceStop": "停止錄音",
    "chat.voiceTranscribing": "SenseVoice 正在轉寫…",
    "chat.voiceDownloading": "正在下載 SenseVoice… {percent}%",
    "chat.voiceLangAuto": "自動中英辨識",
    "chat.voiceLangZh": "中文",
    "chat.voiceLangEn": "英文",
