...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "trust.mcpNotLoaded": "此專案尚未受信任，專案 MCP 伺服器未啟動。",
    "mcp.scopeGlobal": "全域",
    "mcp.scopeProject": "專案",
    "mcp.liveTools": "生效的工具",
    "mcp.liveCount": "目前工作階段有 {count} 個 MCP 工具可用",
    "mcp.addServer": "新增伺服器",
    "mcp.empty": "尚未設定 MCP 伺服器",
    "mcp.emptyHint": "新增一個伺服器，把它的工具提供給代理。",
    "mcp.selectHint": "選擇一個伺服器以編輯。",
    "mcp.fieldName": "名稱",
    "mcp.fieldTransport": "傳輸方式",
    "mcp.transportStdio": "stdio",
    "mcp.transportHttp": "HTTP",
    "mcp.fieldCommand": "指令",
    "mcp.fieldArgs": "參數（每行一個）",
    "mcp.fieldCwd": "工作目錄",
    "mcp.fieldEnv": "環境變數（KEY=value，每行一個）",
    "mcp.fieldUrl": "伺服器 URL",
    "mcp.securityNote": "stdio 伺服器會以你的使用者權限作為本機程序執行。全域伺服器一律啟動；專案伺服器僅在受信任的專案中啟動。",
    "mcp.saved": "已儲存。重新載入工作階段後生效。",
    "mcp.removed": "已移除。重新載入工作階段後生效。",
    "mcp.reloadSession": "重新載入工作階段",
    "mcp.errorCommandRequired": "stdio 伺服器必須填寫指令。",
    "mcp.errorUrlRequired": "HTTP 伺服器必須填寫 URL。",
    "mcp.errorEnvFormat": "環境變數行格式錯誤：{line}",
