...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.defaultDirectory": "預設目錄",
    "settings.defaultDirectoryDescription": "用於專案選擇器中的「使用預設目錄」。留空則使用家目錄下依日期命名的資料夾。`{date}` 會替換為當天的 YYYYMMDD。",
    "settings.defaultDirectoryResolved": "將開啟 {path}",
    "settings.browseDirectory": "瀏覽",
    "settings.resetDefaultDirectory": "重設預設目錄",
