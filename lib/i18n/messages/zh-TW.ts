...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.researchModeDescription": "選取對話中的任意術語即可取得 AI 解釋，可遞迴深入、追溯概念鏈，懸停已解釋的詞可隨時複習。",
    "settings.researchModeToggle": "啟用研究模式",
    "research.webSearch": "用網路搜尋結果核實此解釋",
    "research.webFailed": "搜尋不可達，已使用模型知識回答",
    "research.exportMindmap": "匯出為互動式心智圖（HTML，雙擊即看；內含 .mm 下載供 XMind/FreeMind）",
    "research.exportAnki": "匯出 Anki 匯入檔案（.csv，在 Anki 中 檔案→匯入 使用；用 Excel 開啟只會看到原始碼）",
    ...
    "research.explainAction": "解釋",
    "research.explainHint": "選取任意詞，繼續深入",
    "research.depthBrief": "簡明",
    "research.depthStandard": "標準",
    "research.depthDeep": "深入",
    "research.close": "關閉",
    "research.retry": "重試",
    "research.unknownError": "出了點問題",
    "research.chainTitle": "概念鏈",
    "research.chainEmpty": "在對話中選取任意術語，開始一條研究鏈。",
    "research.export": "匯出為 Markdown",
    "research.clear": "清空整條鏈",
    "research.clearConfirm": "清空整條概念鏈？此操作無法復原。",
    "research.remove": "刪除該術語及其所有下層",
    "research.thinking": "思考中",
    "research.chainStats": "{terms} 個術語 · {chains} 條鏈",
    "research.followupQ": "問",
    "research.followupPlaceholder": "繼續追問這個術語…",
    "research.followupSend": "送出追問",
    "research.followupBadge": "{n} 問",
    "research.hoverOpen": "開啟完整解釋",
  },
};
