...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.index": "工作階段索引",
    "settings.indexDescription": "為工作階段搜尋、導覽與載入建立快速 SQLite 索引。停用後會退回直接掃描 JSONL 檔案。修改後需要重新啟動伺服器。",
    "settings.indexEnabled": "啟用 SQLite 工作階段索引",
    "settings.retry": "重試",
    "settings.retryDescription": "當模型返回錯誤時，Pi 會自動以指數退避方式重試請求。停用後將直接顯示錯誤。",
    "settings.retryEnabled": "錯誤自動重試",
    "settings.retryMaxRetries": "最大重試次數",
    "settings.retryMaxRetriesDescription": "最大自動重試次數。預設值：3。",
    "settings.retryBaseDelay": "基礎延遲（毫秒）",
    "settings.retryBaseDelayDescription": "首次重試前的初始延遲。每次重試後延遲翻倍。預設值：2000ms。",
    "settings.minimap": "聊天小地圖",
    "settings.minimapDescription": "設定顯示訊息位置的聊天小地圖。",
    "settings.minimapMaxNodes": "最大節點數（0 = 全部）",
    "settings.minimapMaxNodesHint": "0 顯示所有訊息。更高的數值限制顯示的節點數量。內容超出時垂直捲動。",
    ...
    "chatMinimap.toolCount": "{count} 次工具",
    "i18n.close": "關閉",
    "i18n.copy": "複製",
    "i18n.copied": "已複製",
    "i18n.cancel": "取消",
