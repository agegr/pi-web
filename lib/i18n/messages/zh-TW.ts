...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.pinnedSessions": "啟用固定工作階段功能",
    ...
    "tools.label": "工具",
    "tools.title": "工具定義",
    "pinnedSessions.label": "固定工作階段",
    "pinnedSessions.title": "固定的工作階段",
    "pinnedSessions.count": "{count} 個固定工作階段",
    "pinnedSessions.running": "執行中",
    "pinnedSessions.pinned": "已固定",
    "pinnedSessions.current": "目前工作階段",
    "pinnedSessions.empty": "目前沒有固定的工作階段",
    "sidebar.pin": "固定工作階段",
    "sidebar.unpin": "取消固定工作階段",
