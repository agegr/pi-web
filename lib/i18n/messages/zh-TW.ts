...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.syncSummary": "上游共 {total} 個模型 · 待新增 {added} 個 · 已下線 {stale} 個",
    "models.syncRemoveStale": "同時移除上游已下線的 {count} 個模型",
    "models.syncApply": "同步模型清單",
    "models.syncHint": "同步只修改草稿，點「儲存」後寫入 models.json",
    "models.syncUpToDate": "已與上游一致",
    "models.builtinBaseUrl": "留空則使用 pi 內建的該 provider 端點",
