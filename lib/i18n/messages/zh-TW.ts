...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.pinnedProjects": "已釘選",
    "sidebar.pinProject": "釘選專案",
    "sidebar.unpinProject": "取消釘選",
    ...
    "sidebar.hidePseudoProjects": "隱藏未合併的 worktree 專案",
    "sidebar.hidePseudoProjectsTitle": "隱藏無法合併回所屬儲存庫的已刪除 worktree 目錄的專案列。關閉後可重新顯示。",
    "sidebar.pseudoProjectsHidden": "已隱藏 {count} 個",
    "sidebar.pseudoProjectsVisible": "顯示 {count} 個",
    ...
    "sidebar.explorerEmpty": "固定或選擇一個專案以瀏覽其檔案",
    ...
    "chat.attachFromCamera": "拍照",
    "chat.attachFromGallery": "從相簿選擇",
    "chat.cameraPermissionDeniedTitle": "相機無法使用",
    "chat.cameraPermissionDeniedBody": "相機權限被拒絕或無法使用。您仍可從相簿附加圖片。",
