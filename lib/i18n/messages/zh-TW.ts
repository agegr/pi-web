...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.undoFirstTurn": "撤回並編輯",
    "chat.undoFirstTurnHint": "捨棄已中止的首輪訊息，將文字和圖片恢復到輸入框，不保留歷史分支。",
    "chat.undoFirstTurnDraftBusy": "請先儲存或清空輸入框中的草稿，再撤回首輪訊息。",
    "chat.undoFirstTurnFailed": "無法撤回首輪訊息。原輸入已恢復到輸入框。",
