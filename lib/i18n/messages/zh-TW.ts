...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.searchSessions": "搜尋歷史對話",
    "sidebar.searchSessionsPlaceholder": "搜尋對話內容…",
    "sidebar.searchingSessions": "正在搜尋對話…",
    "sidebar.noMatchingSessions": "找不到相符的對話",
    "sidebar.searchScopeAll": "全部專案",
    "sidebar.searchScopeProject": "僅 {project}",
    "sidebar.searchIncludeTools": "包含工具輸出",
    "sidebar.searchMinLength": "請至少輸入 {count} 個字元",
