...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.visibilityManage": "管理顯示的模型",
    "models.visibilityTitle": "模型顯示設定",
    "models.visibilityDescription": "選擇哪些模型出現在模型選擇器中。儲存後會寫入 ~/.pi/agent/settings.json 的 enabledModels。",
    "models.visibilitySelectAll": "全選",
    "models.visibilityShown": "已顯示 {shown} / {total}",
    "models.visibilityAdvancedNotice": "目前 enabledModels 使用了萬用字元或思考層級鎖定，儲存後將替換為下方明確的模型清單。",
    "models.visibilityEmptySelection": "至少保留一個可見模型。",
