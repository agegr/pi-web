...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.thinkingStyle": "思考區塊樣式",
    "settings.thinkingStyleDescription": "思考區塊（模型的內部推理過程）的顯示方式。",
    "settings.thinkingCard": "帶圖示的卡片",
    "settings.thinkingMinimal": "極簡模式",
    "settings.diffWrap": "Diff 換行方式",
    "settings.diffWrapDescription": "選擇 diff 檢視器中長行是自動換行還是横向捲動。",
    "settings.diffWrapOn": "自動換行",
    "settings.diffWrapOff": "不換行",
