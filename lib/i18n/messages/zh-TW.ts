...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "shutdown.start": "60 秒關機",
    "shutdown.confirmTitle": "60 秒後關機",
    "shutdown.confirmBody": "確認後本機將在 60 秒後關機，倒計時期間可隨時取消。",
    "shutdown.confirmOk": "確認關機",
    "shutdown.confirmCancel": "取消",
    "shutdown.cancel": "取消",
    "shutdown.remaining": "剩餘 {seconds} 秒",
    "shutdown.cancelling": "取消中…",
    "shutdown.aboutToShutdown": "即將關機",
    "shutdown.failed": "關機命令執行失敗",
  },
};
