...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.askTitle": "提問",
    "chat.askMinimize": "最小化提問",
    "chat.askExpand": "展開",
    "chat.askShowRaw": "顯示終端機檢視",
    "chat.askShowContext": "顯示背景資訊",
    "chat.askHideContext": "隱藏背景資訊",
    "chat.askFreeformPlaceholder": "其他答案……",
    "chat.askCommentPlaceholder": "補充說明（選填）",
    "chat.askSkip": "略過",
    "chat.askSubmit": "送出",
    "chat.askSubmitCount": "送出 {count} 項",
    "chat.askPending": "等待回答",
    "chat.askAnswered": "已回答",
    "chat.askCancelled": "已略過",
    "chat.askFreeformAnswer": "回答",
    "chat.askComment": "補充說明",
