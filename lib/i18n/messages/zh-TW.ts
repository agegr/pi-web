...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "trajectory.label": "軌跡",
    "trajectory.title": "軌跡",
    "trajectory.loading": "載入軌跡…",
    "trajectory.error": "軌跡載入失敗",
    "trajectory.close": "關閉",
    "trajectory.empty": "此工作階段還沒有事件",
    "trajectory.loadEarlier": "載入更早",
    "trajectory.loadingEarlier": "載入中…",
    "trajectory.overview": "時間概覽",
    "trajectory.legendWait": "等待首 token",
    "trajectory.legendDecode": "解碼",
    "trajectory.legendTool": "工具",
    "trajectory.turn": "輪次 {index}",
    "trajectory.model": "模型",
    "trajectory.tool": "工具",
    "trajectory.user": "使用者",
    ...
    "trajectory.customMessage": "注入訊息",
    "trajectory.other": "其他",
    "trajectory.toolCalls": "{count} 次工具呼叫",
    "trajectory.partialTurn": "部分載入",
    "trajectory.branchSummaryCounts": "{turns} 輪 · {rows} 筆記錄",
    "trajectory.timingCoverage": "計時覆蓋 {timed}/{total}",
    "trajectory.timingMissing": "TTFT 與輸出速度僅對啟用計時擷取之後的請求可見",
    "trajectory.startedAt": "開始",
    "trajectory.duration": "耗時",
    "trajectory.modelName": "模型",
    "trajectory.stopReason": "結束原因",
    "trajectory.tokens": "Token",
    "trajectory.tokenBreakdown": "輸入 {input} · 輸出 {output} · 快取讀取 {cacheRead}",
    "trajectory.cost": "費用",
    "trajectory.ttft": "TTFT",
    "trajectory.decode": "解碼",
    "trajectory.toolCallId": "工具呼叫 ID",
    "trajectory.args": "參數",
    "trajectory.result": "輸出",
    ...
    "session.timingSection": "計時",
    "session.modelTime": "模型用時",
    "session.toolTime": "工具呼叫用時",
    "session.ttft": "首 token 平均 (TTFT)",
    "session.tps": "輸出速度 (TPS)",
