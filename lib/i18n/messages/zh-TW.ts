...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "directoryPicker.createDirectory": "新增目錄",
    "directoryPicker.directoryName": "目錄名稱",
    "directoryPicker.directoryNamePlaceholder": "請輸入目錄名稱",
    "directoryPicker.confirmAndSelect": "確認並選擇",
    "directoryPicker.confirm": "確認",
    "directoryPicker.creating": "正在建立…",
