...
export const zhTWLocale: LocalePlugin = {
  ...
  label: "繁體中文",
  messages: {
    "workspace.configureModel": "設定模型",
    "settings.modelsEmptyTitle": "連接你的第一個模型",
    "settings.modelsEmptyDescription": "新增 Provider，設定 API Key、訂閱登入或自訂相容端點。",
    "settings.skillsEmptyTitle": "為工作台新增技能",
    "settings.skillsEmptyDescription": "搜尋並安裝技能，讓 AI 按需使用專門的任務指引。",
    "settings.pluginSource": "來源",
    "settings.pluginExamples": "範例",
    "settings.pluginsEmpty": "尚無外掛",
    "workspace.newConversation": "新增對話",
    "workspace.conversations": "對話",
    "workspace.actions": "工作台操作",
    "workspace.welcomeDescription": "選擇專案並連接模型，開始與 Pi 一起工作。",
    "workspace.startConversation": "在專案中開始對話",
    "workspace.conversationDescription": "基於程式碼庫，和 AI 一起探索、撰寫、修改和理解程式碼。",
    "common.ok": "確定",
    "common.language": "語言",
    "common.models": "模型",
    "common.skills": "技能",
