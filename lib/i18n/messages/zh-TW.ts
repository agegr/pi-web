...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.title": "設定",
    "settings.general": "一般",
    "settings.sessionTitle": "會話標題",
    "settings.sessionTitleDescription": "選擇用於命名會話的模型，並在模型支援的範圍內降低思考開銷。",
    "settings.sessionTitleModel": "標題模型",
    "settings.sessionTitleModelInherit": "使用會話自身的模型（預設）",
