...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sideChat.label": "側聊",
    "sideChat.title": "側聊",
    "sideChat.opening": "正在開啟側聊…",
    "sideChat.close": "關閉側聊",
    "sideChat.inherited": "已繼承 {count} 則訊息",
    "sideChat.ephemeral": "不落盤，關閉即消失",
    "sideChat.placeholder": "問點什麼，不影響主對話的任務",
    "sideChat.send": "傳送",
    "sideChat.stop": "停止",
    "sideChat.bringBack": "帶回主對話",
    "sideChat.broughtBack": "已填入主輸入框",
    "sideChat.bringBackHint": "把最後一則回答填入主輸入框",
    "sideChat.reclaimed": "此側聊已過期，傳送時會自動開一個新的",
    "sideChat.revived": "上一個側聊已過期，已開啟新的側聊並重送你的問題（舊的側聊問答不保留）",
