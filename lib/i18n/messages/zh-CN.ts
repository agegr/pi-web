...
export const zhCNLocale: LocalePlugin = {
  ...
  label: "简体中文",
  messages: {
    "workspace.configureModel": "配置模型",
    "settings.modelsEmptyTitle": "连接你的第一个模型",
    "settings.modelsEmptyDescription": "添加 Provider，配置 API Key、订阅登录或自定义兼容端点。",
    "settings.skillsEmptyTitle": "为工作台添加技能",
    "settings.skillsEmptyDescription": "搜索并安装技能，让 AI 按需使用专门的任务指引。",
    "settings.pluginSource": "来源",
    "settings.pluginExamples": "示例",
    "settings.pluginsEmpty": "暂无插件",
    "workspace.newConversation": "新建会话",
    "workspace.conversations": "会话",
    "workspace.actions": "工作台操作",
    "workspace.welcomeDescription": "选择项目并连接模型，开始与 Pi 一起工作。",
    "workspace.startConversation": "在项目中开始对话",
    "workspace.conversationDescription": "基于代码库，和 AI 一起探索、编写、修改和理解代码。",
    "common.ok": "确定",
    "common.language": "语言",
    "common.models": "模型",
    "common.skills": "技能",
