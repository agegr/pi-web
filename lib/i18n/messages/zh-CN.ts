...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.sessionTitle": "会话标题",
    "settings.sessionTitleDescription": "选择用于命名会话的模型，并在模型支持的范围内降低思考开销。",
    "settings.sessionTitleModel": "标题模型",
    "settings.sessionTitleModelInherit": "使用会话自身的模型（默认）",
