...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "auth.loginTitle": "登录到 Pi Web",
    "auth.loginSubtitle": "请输入账号与密码以访问控制台与智能会话",
    "auth.title": "欢迎登录 Pi Web",
    "auth.description": "请输入账号与密码以访问控制台与智能会话",
    ...
    "auth.invalidPassword": "密码不正确，请重试",
    "auth.networkError": "登录请求失败，请检查网络",
    "auth.welcomeBack": "欢迎回来",
    "auth.secureSession": "受密码保护的访问会话",
    "auth.hidePassword": "隐藏密码",
    "auth.showPassword": "显示密码",
    "auth.rememberMe": "记住登录状态",
  },
};
