...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.startDictation": "开始听写",
    "chat.stopDictation": "停止听写",
    "chat.listening": "正在聆听…",
    "chat.dictationError.aborted": "听写已停止",
    "chat.dictationError.audio-capture": "无法使用麦克风",
    "chat.dictationError.network": "语音识别网络错误",
    "chat.dictationError.no-speech": "未检测到语音",
    "chat.dictationError.not-allowed": "麦克风权限被拒绝",
    "chat.dictationError.service-not-allowed": "语音识别不可用",
    "chat.dictationError.unknown": "听写失败",
