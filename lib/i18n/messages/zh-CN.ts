...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "pair.connectPhone": "连接手机",
    "pair.title": "在手机上打开",
    "pair.scanWithPhone": "用手机相机扫描二维码即可打开。",
    "pair.urlLabel": "或输入网址",
    "pair.passwordLabel": "配对密码（只需输入一次）",
    "pair.passwordHint": "首次登录后，手机将记住 30 天，无需重复输入。",
    "pair.copy": "复制",
    "pair.copied": "已复制",
    "pair.loading": "加载中…",
    "pair.error": "无法加载连接信息",
    "pair.regenerate": "重新生成",
    "pair.regenerateEnvLocked": "密码由 PI_WEB_PASSWORD 环境变量设置，请修改环境变量后重启。",
    "pair.notSet": "未设置密码（同一网络任何人都可访问）。",
    "pair.noHostnameWarning": "服务未绑定地址，二维码仅含 loopback。",
    "pair.usernameLabel": "用户名",
  },
};
