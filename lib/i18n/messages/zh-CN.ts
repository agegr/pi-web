...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.askTitle": "提问",
    "chat.askMinimize": "最小化提问",
    "chat.askExpand": "展开",
    "chat.askShowRaw": "显示终端视图",
    "chat.askShowContext": "显示背景信息",
    "chat.askHideContext": "隐藏背景信息",
    "chat.askFreeformPlaceholder": "其他答案……",
    "chat.askCommentPlaceholder": "补充说明（可选）",
    "chat.askSkip": "跳过",
    "chat.askSubmit": "提交",
    "chat.askSubmitCount": "提交 {count} 项",
    "chat.askPending": "等待回答",
    "chat.askAnswered": "已回答",
    "chat.askCancelled": "已跳过",
    "chat.askFreeformAnswer": "回答",
    "chat.askComment": "补充说明",
