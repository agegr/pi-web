...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.catalog": "模型目录",
    "models.catalogEmpty": "该供应商目录中没有模型",
    "models.toggleHint": "切换该模型是否显示在模型选择器中",
    "models.backfillNotice": "已为新供应商自动保留全部模型（provider/*）：{providers}",
    "models.refreshCatalog": "刷新模型",
    "models.refreshCatalogHint": "重新拉取远程模型目录（pi.dev）。pi-web 平时只读本机缓存。",
    "models.refreshing": "刷新中…",
    "models.imageTag": "图像",
    "models.supportsImage": "支持图像输入",
    "models.reasoningTag": "推理",
    "models.supportsReasoning": "支持扩展推理",
    "models.whitelistActive": "白名单已启用：{count} 条模式",
    "models.whitelistInactive": "白名单未启用：全部模型可见",
    "models.masterToggleHint": "批量开关该供应商的全部模型",
    ...
    "i18n.deleteProviderConfirm": "删除自定义供应商 {provider}？将同时删除其模型定义与保存在其中的 API key，此操作不可恢复。",
    "i18n.deleteModelConfirm": "移除模型 {model}？",
    "i18n.removeOAuthConfirm": "移除 {provider} 的连接？将删除已保存的登录凭证，该供应商的模型将不可用，直至重新登录。",
    "i18n.removeKeyConfirm": "移除 {provider} 的 API key？该供应商的模型将不可用，直至重新填写。",
