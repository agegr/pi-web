...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.backgroundDescription": "仅保存在当前浏览器中，自动保留最近 20 张图片。",
    "settings.backgroundChoose": "选择图片",
    "settings.backgroundSaving": "保存中…",
    "settings.backgroundDisable": "关闭背景",
    "settings.backgroundOpacity": "图片透明度",
    "settings.backgroundHistory": "近期背景",
    "settings.backgroundUse": "使用 {name} 作为背景",
    "settings.backgroundRemove": "删除背景",
    "settings.backgroundRemoveNamed": "删除 {name}",
