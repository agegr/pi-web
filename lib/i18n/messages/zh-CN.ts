...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.pinnedSessions": "启用固定会话功能",
    ...
    "tools.label": "工具",
    "tools.title": "工具定义",
    "pinnedSessions.label": "固定会话",
    "pinnedSessions.title": "固定的会话",
    "pinnedSessions.count": "{count} 个固定会话",
    "pinnedSessions.running": "运行中",
    "pinnedSessions.pinned": "已固定",
    "pinnedSessions.current": "当前会话",
    "pinnedSessions.empty": "暂无固定的会话",
    "sidebar.pin": "固定会话",
    "sidebar.unpin": "取消固定会话",
