...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "shutdown.start": "60 秒关机",
    "shutdown.confirmTitle": "60 秒后关机",
    "shutdown.confirmBody": "确认后本机将在 60 秒后关机，倒计时期间可随时取消。",
    "shutdown.confirmOk": "确认关机",
    "shutdown.confirmCancel": "取消",
    "shutdown.cancel": "取消",
    "shutdown.remaining": "剩余 {seconds} 秒",
    "shutdown.cancelling": "取消中…",
    "shutdown.aboutToShutdown": "即将关机",
    "shutdown.failed": "关机命令执行失败",
  },
};
