...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "trust.mcpNotLoaded": "此项目尚未受信任，项目 MCP 服务器未启动。",
    "mcp.scopeGlobal": "全局",
    "mcp.scopeProject": "项目",
    "mcp.liveTools": "生效的工具",
    "mcp.liveCount": "当前会话有 {count} 个 MCP 工具可用",
    "mcp.addServer": "添加服务器",
    "mcp.empty": "尚未配置 MCP 服务器",
    "mcp.emptyHint": "添加一个服务器，把它的工具提供给智能体。",
    "mcp.selectHint": "选择一个服务器以编辑。",
    "mcp.fieldName": "名称",
    ...
    "mcp.fieldCwd": "工作目录",
    "mcp.fieldEnv": "环境变量（KEY=value，每行一个）",
    "mcp.fieldUrl": "服务器 URL",
    "mcp.securityNote": "stdio 服务器会以你的用户权限作为本地进程运行。全局服务器总是启动；项目服务器仅在受信任的项目中启动。",
    "mcp.saved": "已保存。重载会话后生效。",
    "mcp.removed": "已移除。重载会话后生效。",
    "mcp.reloadSession": "重载会话",
    "mcp.errorCommandRequired": "stdio 服务器必须填写命令。",
    "mcp.errorUrlRequired": "HTTP 服务器必须填写 URL。",
    "mcp.errorEnvFormat": "环境变量行格式错误：{line}",
