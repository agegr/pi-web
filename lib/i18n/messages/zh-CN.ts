...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.thinkingStyle": "思考块样式",
    "settings.thinkingStyleDescription": "思考块（模型的内部推理过程）的展示方式。",
    "settings.thinkingCard": "带图标的卡片",
    "settings.thinkingMinimal": "极简模式",
    "settings.diffWrap": "Diff 换行方式",
    "settings.diffWrapDescription": "选择 diff 查看器中长行是自动换行还是横向滚动。",
    "settings.diffWrapOn": "自动换行",
    "settings.diffWrapOff": "不换行",
