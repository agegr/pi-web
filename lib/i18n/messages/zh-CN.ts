...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.researchMode": "研究模式",
    "settings.researchModeDescription": "选中对话中的任意术语即可获得 AI 解释，可递归深入、追溯概念链，悬停已解释的词可随时复习。",
    "settings.researchModeToggle": "启用研究模式",
    "research.webSearch": "用联网搜索结果核实此解释",
    "research.webFailed": "搜索不可达，已使用模型知识回答",
    "research.exportMindmap": "导出为交互式思维导图（HTML，双击即看；内含 .mm 下载供 XMind/FreeMind）",
    "research.exportAnki": "导出 Anki 导入文件（.csv，在 Anki 中 文件→导入 使用；用 Excel 打开只会看到源码）",
    ...
    "research.explainAction": "解释",
    "research.explainHint": "选中任意词，继续深入",
    "research.depthBrief": "简明",
    "research.depthStandard": "标准",
    "research.depthDeep": "深入",
    "research.close": "关闭",
    "research.retry": "重试",
    "research.unknownError": "出了点问题",
    "research.chainTitle": "概念链",
    "research.chainEmpty": "在对话中选中任意术语，开始一条研究链。",
    "research.export": "导出为 Markdown",
    "research.clear": "清空整条链",
    "research.clearConfirm": "清空整条概念链？此操作无法撤销。",
    "research.remove": "删除该术语及其所有下级",
    "research.thinking": "思考中",
    "research.chainStats": "{terms} 个术语 · {chains} 条链",
    "research.followupQ": "问",
    "research.followupPlaceholder": "继续追问这个术语…",
    "research.followupSend": "发送追问",
    "research.followupBadge": "{n} 问",
    "research.hoverOpen": "打开完整解释",
  },
};
