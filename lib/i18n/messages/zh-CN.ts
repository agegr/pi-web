...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "trajectory.label": "轨迹",
    "trajectory.title": "轨迹",
    "trajectory.loading": "加载轨迹…",
    "trajectory.error": "轨迹加载失败",
    "trajectory.close": "关闭",
    "trajectory.empty": "此会话还没有事件",
    "trajectory.loadEarlier": "加载更早",
    "trajectory.loadingEarlier": "加载中…",
    "trajectory.overview": "时间概览",
    "trajectory.legendWait": "等待首 token",
    "trajectory.legendDecode": "解码",
    "trajectory.legendTool": "工具",
    "trajectory.turn": "轮次 {index}",
    "trajectory.model": "模型",
    "trajectory.tool": "工具",
    "trajectory.user": "用户",
    ...
    "trajectory.customMessage": "注入消息",
    "trajectory.other": "其他",
    "trajectory.toolCalls": "{count} 次工具调用",
    "trajectory.partialTurn": "部分加载",
    "trajectory.branchSummaryCounts": "{turns} 轮 · {rows} 条记录",
    "trajectory.timingCoverage": "计时覆盖 {timed}/{total}",
    "trajectory.timingMissing": "TTFT 与输出速度仅对启用计时采集之后的请求可见",
    "trajectory.startedAt": "开始",
    "trajectory.duration": "耗时",
    "trajectory.modelName": "模型",
    "trajectory.stopReason": "结束原因",
    "trajectory.tokens": "Token",
    "trajectory.tokenBreakdown": "输入 {input} · 输出 {output} · 缓存读取 {cacheRead}",
    "trajectory.cost": "费用",
    "trajectory.ttft": "TTFT",
    "trajectory.decode": "解码",
    "trajectory.toolCallId": "工具调用 ID",
    "trajectory.args": "参数",
    "trajectory.result": "输出",
    ...
    "session.timingSection": "计时",
    "session.modelTime": "模型用时",
    "session.toolTime": "工具调用用时",
    "session.ttft": "首 token 平均 (TTFT)",
    "session.tps": "输出速度 (TPS)",
