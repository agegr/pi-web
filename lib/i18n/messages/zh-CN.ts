...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "directoryPicker.noFoldersYet": "没有文件夹",
    "directoryPicker.createFolder": "+ 创建文件夹",
    "directoryPicker.cloneRepo": "克隆仓库",
    "directoryPicker.newFolder": "+ 新建文件夹",
    "directoryPicker.cloneButton": "克隆",
    "directoryPicker.cloning": "正在克隆… {elapsed}",
    "directoryPicker.matchingFolders": "匹配的文件夹：",
    "directoryPicker.createFolderPlaceholder": "例如 my-project",
    "directoryPicker.cloneRepoPlaceholder": "https://github.com/user/repo.git",
    "directoryPicker.folderNameNoDot": "文件夹名不能以点号开头",
    "directoryPicker.createNewFolder": "创建新文件夹",
    "directoryPicker.cloneGitRepo": "克隆仓库",
