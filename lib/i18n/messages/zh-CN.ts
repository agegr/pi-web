...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.network": "网络",
    "network.title": "网络代理",
    "network.subtitle": "配置服务端访问外部模型 API 的网络出口。",
    "network.close": "关闭网络设置",
    "network.loading": "正在加载网络设置…",
    "network.effective": "当前生效代理",
    "network.source": "配置来源",
    "network.source.environment": "环境变量",
    "network.source.saved": "页面覆盖配置",
    "network.source.windows-system": "Windows 系统代理",
    "network.source.direct": "直接连接",
    "network.environmentLocked": "当前代理由环境变量管理，无法在页面中覆盖。",
    "network.windowsDetection": "Windows 检测结果",
    "network.windowsAvailable": "已读取当前用户的 Windows Internet Settings。",
    "network.windowsUnavailable": "无法读取 Windows Internet Settings。",
    "network.wpadDetected": "Windows 已启用自动代理检测（WPAD）。",
    "network.pacWarning": "当前仅配置了 PAC/WPAD。Pi Web 会显示检测结果，但不能执行 PAC 规则；请在下方填写固定代理地址。",
    "network.override": "页面覆盖配置",
    "network.enableOverride": "使用此代理配置",
    "network.httpProxy": "HTTP 代理",
    "network.httpsProxy": "HTTPS 代理",
    "network.test": "测试代理",
    "network.testing": "测试中…",
    "network.testSuccess": "已成功连接到模型服务商",
    "network.save": "保存并应用",
    "network.saving": "保存中…",
    "network.saved": "代理设置已保存并应用。",
    "network.clear": "恢复自动配置",
    "network.cleared": "页面覆盖配置已清除，已恢复自动配置。",
    "network.cancel": "取消",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
    "theme.light": "切换到浅色模式",
