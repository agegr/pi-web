...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.defaultDirectoryDescription": "用于项目选择器中的“使用默认目录”。留空则使用主目录下按日期命名的文件夹。`{date}` 会替换为当天的 YYYYMMDD。",
    "settings.defaultDirectoryResolved": "将打开 {path}",
    "settings.browseDirectory": "浏览",
    "settings.resetDefaultDirectory": "重置默认目录",
