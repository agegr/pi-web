...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "directoryPicker.createDirectory": "新建目录",
    "directoryPicker.directoryName": "目录名",
    "directoryPicker.directoryNamePlaceholder": "请输入目录名",
    "directoryPicker.confirmAndSelect": "确认并选择",
    "directoryPicker.confirm": "确认",
    "directoryPicker.creating": "正在创建…",
