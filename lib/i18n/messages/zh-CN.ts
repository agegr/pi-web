...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.undoFirstTurn": "撤回并编辑",
    "chat.undoFirstTurnHint": "丢弃已中止的首轮消息，将文字和图片恢复到输入框，不保留历史分支。",
    "chat.undoFirstTurnDraftBusy": "请先保存或清空输入框中的草稿，再撤回首轮消息。",
    "chat.undoFirstTurnFailed": "无法撤回首轮消息。原输入已恢复到输入框。",
