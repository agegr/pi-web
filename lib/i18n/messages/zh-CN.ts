...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "history.label": "完整历史",
    "export.title": "会话导出",
    "export.openSidebar": "打开侧边栏",
    "export.search": "搜索...",
    "export.filterDefault": "默认",
    "export.filterDefaultTitle": "隐藏设置项",
    "export.filterNoTools": "无工具",
    "export.filterNoToolsTitle": "默认视图，但不显示工具结果",
    "export.filterUser": "用户",
    "export.filterUserTitle": "仅显示用户消息",
    "export.filterLabeled": "已标记",
    "export.filterLabeledTitle": "仅显示带标签的条目",
    "export.filterAll": "全部",
    "export.filterAllTitle": "显示全部内容",
    "export.close": "关闭",
    "export.resizeSidebar": "调整会话树侧边栏宽度",
    "export.entries": "{visible} / {total} 个条目",
    "export.roleSkill": "技能",
    "export.roleUser": "用户",
    "export.roleAssistant": "助手",
    "export.abortedParenthetical": "（已中止）",
    "export.noText": "（无文本）",
    "export.compactionTree": "[压缩：{count}k Token]",
    "export.branchSummaryTree": "[分支摘要]：",
    "export.modelTree": "[模型：{model}]",
    "export.thinkingTree": "[思考：{level}]",
    "export.moreLinesExpand": "...（另有 {count} 行，点击展开）",
    "export.moreLines": "...（另有 {count} 行）",
    "export.lines": "（{count} 行）",
    "export.invalidArg": "[参数无效]",
    "export.invalidContent": "[内容参数无效，应为字符串]",
    "export.copyLink": "复制此消息的链接",
    "export.clickToExpand": "{name}（点击展开）",
    "export.thinking": "思考中...",
    "export.aborted": "已中止",
    "export.error": "错误",
    "export.unknownError": "未知错误",
    "export.cancelled": "（已取消）",
    "export.exitCode": "（退出码 {code}）",
    "export.switchedModel": "已切换到模型",
    "export.compactionLabel": "[压缩]",
    "export.compactedFrom": "由 {count} 个 Token 压缩而来",
    "export.branchSummary": "分支摘要",
    "export.userMessages": "{count} 条用户消息",
    "export.assistantMessages": "{count} 条助手消息",
    "export.toolResults": "{count} 条工具结果",
    "export.customMessages": "{count} 条自定义消息",
    "export.compactions": "{count} 次压缩",
    "export.branchSummaries": "{count} 条分支摘要",
    "export.session": "会话",
    "export.unknown": "未知",
    "export.helpHint": "T 切换思考内容 · O 切换工具输出",
    "export.toggleThinking": "切换思考内容",
    "export.toggleThinkingTitle": "切换思考内容（T）",
    "export.toggleTools": "切换工具输出",
    "export.toggleToolsTitle": "切换工具输出（O）",
    "export.downloadJson": "下载会话 JSONL",
    "export.date": "日期",
    "export.models": "模型",
    "export.messages": "消息",
    ...
    "export.tokens": "Token",
    "export.cost": "费用",
    "export.systemPrompt": "系统提示词",
    "export.availableTools": "可用工具",
    "export.required": "必填",
    "export.optional": "可选",
