...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sideChat.label": "侧聊",
    "sideChat.title": "侧聊",
    "sideChat.opening": "正在开启侧聊…",
    "sideChat.close": "关闭侧聊",
    "sideChat.inherited": "已继承 {count} 条消息",
    "sideChat.ephemeral": "不落盘，关闭即消失",
    "sideChat.placeholder": "问点什么，不影响主对话的任务",
    "sideChat.send": "发送",
    "sideChat.stop": "停止",
    "sideChat.bringBack": "带回主对话",
    "sideChat.broughtBack": "已填入主输入框",
    "sideChat.bringBackHint": "把最后一条回答填入主输入框",
    "sideChat.reclaimed": "此侧聊已过期，发送时会自动开一个新的",
    "sideChat.revived": "上一个侧聊已过期，已开启新的侧聊并重发了你的问题（旧的侧聊问答不保留）",
