...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.steerNowPlaceholder": "立即引导…",
    "chat.followUpPlaceholder": "排队后续消息…",
    ...
    "trajectory.empty": "还没有轨迹数据。先让 Pi 做点事，就会开始记录。",
    "trajectory.error.noSidecar": "此功能发布前创建的会话没有轨迹。",
    "trajectory.error.unavailable": "此会话没有可用的轨迹。",
    "trajectory.error.loadFailed": "轨迹加载失败。",
    "trajectory.metric.requests": "请求",
    "trajectory.metric.tools": "工具",
    "trajectory.metric.tokens": "Token",
    "trajectory.metric.active": "活跃",
    "trajectory.metric.compactions": "压缩",
    "trajectory.metric.retries": "重试",
    "trajectory.timeline.title": "时间总览",
    "trajectory.timeline.hint": "点击色块查看详情",
    "trajectory.lane.model": "模型",
    "trajectory.lane.tool": "工具",
    "trajectory.lane.subagent": "子代理",
    "trajectory.lane.compaction": "压缩",
    "trajectory.spanRunning": "进行中",
    "trajectory.searchPlaceholder": "搜索事件…",
    "trajectory.searchLabel": "搜索轨迹事件",
    "trajectory.filterType": "按类型筛选",
    "trajectory.filterStatus": "按状态筛选",
    "trajectory.col.seq": "#",
    "trajectory.col.turn": "轮次",
    "trajectory.col.type": "类型",
    "trajectory.col.event": "事件",
    "trajectory.col.time": "耗时",
    "trajectory.col.status": "状态",
    "trajectory.expand": "展开子代理轨迹",
    "trajectory.collapse": "收起子代理轨迹",
    "trajectory.noMatches": "没有符合当前筛选的事件。",
    "trajectory.childRequests": "{count} 个请求",
    "trajectory.childTools": "{count} 个工具",
    "trajectory.childTokens": "{count} tokens",
    "trajectory.childActive": "活跃 {duration}",
    "trajectory.childMore": "另有 {count} 条记录",
    "trajectory.kind.all": "全部",
    "trajectory.kind.request": "请求",
    "trajectory.kind.tool": "工具",
    "trajectory.kind.retry": "重试",
    "trajectory.kind.compaction": "压缩",
    "trajectory.kind.subagent": "子代理",
    "trajectory.kind.turn": "轮次",
    "trajectory.kind.error": "错误",
    "trajectory.kind.other": "其他",
    "trajectory.status.all": "全部",
    "trajectory.status.running": "进行中",
    "trajectory.status.complete": "完成",
    "trajectory.status.aborted": "已中止",
    "trajectory.status.error": "错误",
    "trajectory.inspectEmpty": "选择一条记录查看详情",
    "trajectory.tab.overview": "概览",
    "trajectory.tab.input": "输入",
    "trajectory.tab.output": "输出",
    "trajectory.tab.timing": "时间",
    "trajectory.tab.usage": "用量",
    "trajectory.field.kind": "类型",
    "trajectory.field.status": "状态",
    "trajectory.field.started": "开始",
    "trajectory.field.ended": "结束",
    "trajectory.field.duration": "耗时",
    "trajectory.field.turn": "轮次",
    "trajectory.field.request": "请求",
    "trajectory.field.step": "步骤",
    "trajectory.field.childSession": "子会话",
    "trajectory.field.summary": "摘要",
    "trajectory.durationRunning": "进行中",
    "trajectory.privacyPending": "这条记录的完整输入和输出保存在本地会话轨迹里，可能包含文件路径、工具参数和命令输出。",
    "trajectory.privacySummary": "摘要模式下隐藏输入和输出。",
    "trajectory.confirmLoad": "确认并加载",
    "trajectory.cancel": "取消",
    "trajectory.loadDetails": "加载完整详情",
    "trajectory.closeInspector": "关闭详情",
    "trajectory.recordLabel": "记录 {kind}",
  },
};
