...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "auth.token": "初始化 token",
    "auth.password": "访问密码",
    "auth.currentPassword": "当前密码",
    "auth.newPassword": "新密码",
    "auth.confirmNewPassword": "确认新密码",
    "auth.confirmPassword": "确认密码",
    "auth.changePassword": "修改访问密码",
    "auth.saveAndRelogin": "保存并重新登录",
    "auth.logout": "退出登录",
    "auth.close": "关闭",
    "auth.processing": "处理中...",
    "auth.login.title": "登录 Pi Web",
    "auth.login.description": "输入访问密码以继续使用工作区。",
    "auth.login.submit": "登录",
    "auth.setup.title": "初始化访问保护",
    "auth.setup.description": "使用服务端提供的一次性 token 设置访问密码。",
    "auth.setup.submit": "初始化",
    "auth.error.AUTH_INVALID_PARAMETERS": "请求参数无效。",
    "auth.error.AUTH_PASSWORD_MISMATCH": "两次密码不一致。",
    "auth.error.AUTH_LOGIN_RATE_LIMITED": "登录尝试过于频繁，请稍后再试。",
    "auth.error.AUTH_SETUP_RATE_LIMITED": "初始化尝试过于频繁，请稍后再试。",
    "auth.error.AUTH_LOGIN_FAILED": "登录失败，请稍后再试。",
    "auth.error.AUTH_SETUP_TOKEN_INVALID": "初始化 token 无效。",
    "auth.error.AUTH_ALREADY_INITIALIZED": "认证已经初始化。",
    "auth.error.AUTH_PASSWORD_INVALID": "密码格式无效。",
    "auth.error.AUTH_SETUP_FAILED": "认证初始化失败，请稍后再试。",
    "auth.error.AUTH_NETWORK_ERROR": "网络错误，请重试。",
    "auth.error.AUTH_PASSWORD_CHANGE_FAILED": "密码修改失败，请稍后再试。",
    "auth.error.AUTH_LOGOUT_FAILED": "退出登录失败，请稍后再试。",
    "common.models": "模型",
    "common.skills": "技能",
    "common.plugins": "插件",
    "settings.title": "设置",
