...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.browserTitle": "浏览器标签页标题",
    "settings.browserTitleDescription": "选择浏览器标签页为当前工作区显示的内容。",
    "settings.browserTitleSession": "会话名称",
    "settings.browserTitleWorkspace": "仅工作区",
