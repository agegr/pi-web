...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.hidePseudoProjects": "隐藏未合并的 worktree 项目",
    "sidebar.hidePseudoProjectsTitle": "隐藏无法合并回所属仓库的已删除 worktree 目录的项目行。关闭后可重新显示。",
    "sidebar.pseudoProjectsHidden": "已隐藏 {count} 个",
    "sidebar.pseudoProjectsVisible": "显示 {count} 个",
    ...
    "sidebar.explorerEmpty": "固定或选择一个项目以浏览其文件",
