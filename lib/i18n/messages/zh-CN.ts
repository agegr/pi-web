...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.new": "新建",
    "sidebar.navigationScope": "会话范围",
    "sidebar.workspace": "工作区",
    "sidebar.global": "全局",
    "sidebar.globalPlaceholder": "全局会话导航将在这里提供。",
    "sidebar.searchGlobalSessions": "搜索会话、项目或路径…",
    "sidebar.clearGlobalSearch": "清除全局会话搜索",
    "sidebar.history": "历史",
    "sidebar.noHistory": "暂无历史会话",
    "sidebar.historyEmptyHint": "已完成的会话会显示在这里。",
    "sidebar.historyLoadError": "暂时无法获取会话历史",
    "sidebar.completed": "已完成",
    "sidebar.cwdUnavailable": "cwd 不可用",
    "sidebar.running": "正在运行",
    "sidebar.runningStatusCompacting": "上下文压缩中",
    "sidebar.runningStatusExecuting": "执行命令",
    "sidebar.runningStatusGenerating": "生成中",
    "sidebar.runningStatusProcessing": "处理中/等待中",
    "sidebar.runningStatusUnknown": "状态未知",
    "sidebar.runningLoading": "正在加载运行会话…",
    "sidebar.runningLoadError": "暂时无法获取运行状态",
    "sidebar.retry": "重试",
    "sidebar.noRunning": "当前没有运行会话",
    "sidebar.noMatchingRunning": "没有匹配的运行会话",
    "sidebar.noMatchingHistory": "没有匹配的历史会话",
    "sidebar.noMatchingHistoryHint": "可以尝试标题、项目名或 cwd",
    "sidebar.loadEarlierSessions": "加载更早会话（{count} 条）",
    "sidebar.queuedMessages": "{count} 条消息排队中",
