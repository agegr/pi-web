...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "web.newTab": "新网页",
    "web.address": "网页地址",
    "web.addressPlaceholder": "输入 URL，例如 www.google.com",
    "web.go": "打开",
    "web.reload": "重新加载页面",
    ...
    "attach.reviewing": "查看中 — 点击继续此会话",
    "attach.reviewingHint": "继续此会话。会先准备工作目录，因此会切换到此会话对应的分支。",
    "attach.attaching": "正在准备工作目录…",
    "attach.attached": "活动",
    "attach.attachedHint": "此会话已激活，并占用其工作目录。",
    "attach.reviewingChip": "查看中",
    "attach.reviewingChipHint": "只读。在你继续此会话之前，它不会影响你的文件。",
    "attach.conflictBusy": "另一个会话正在此工作目录中运行：{session}。请等待其完成，或继续以只读方式查看。",
    "attach.failed": "无法继续此会话：{error}",
    "attach.detach": "释放工作目录",
    "sidebar.new": "新建",
    ...
    "chat.followUp": "后续消息",
    "chat.send": "发送",
    "chat.quotedSections": "引用内容",
    "chat.quoteCommentPlaceholder": "添加你的问题或评论…",
    "chat.moveQuoteUp": "上移引用",
    "chat.moveQuoteDown": "下移引用",
    "chat.removeQuote": "删除引用",
    ...
    "chat.replyInMain": "在主对话中回复",
    "chat.startingThread": "新建线程：{title}",
    "chat.replyingInThread": "正在线程中回复：{title}",
    "chat.threadEmpty": "请使用下方输入框发送第一条消息。",
    "chat.threadLoadFailed": "无法加载此线程。",
    ...
    "i18n.quoteSelection": "引用所选内容",
    "i18n.quoteSelectionTitle": "将所选文字添加到回复",
    "i18n.quoteResponse": "引用回复",
