...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.searchSessions": "搜索历史对话",
    "sidebar.searchSessionsPlaceholder": "搜索对话内容…",
    "sidebar.searchingSessions": "正在搜索对话…",
    "sidebar.noMatchingSessions": "没有匹配的对话",
    "sidebar.searchScopeAll": "全部项目",
    "sidebar.searchScopeProject": "仅 {project}",
    "sidebar.searchIncludeTools": "包含工具输出",
    "sidebar.searchMinLength": "请至少输入 {count} 个字符",
