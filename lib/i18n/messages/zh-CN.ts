...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.visibilityManage": "管理显示的模型",
    "models.visibilityTitle": "模型显示设置",
    "models.visibilityDescription": "选择哪些模型出现在模型选择器中。保存后会写入 ~/.pi/agent/settings.json 的 enabledModels。",
    "models.visibilitySelectAll": "全选",
    "models.visibilityShown": "已显示 {shown} / {total}",
    "models.visibilityAdvancedNotice": "当前 enabledModels 使用了通配符或思考级别锁定，保存后将替换为下方明确的模型列表。",
    "models.visibilityEmptySelection": "至少保留一个可见模型。",
