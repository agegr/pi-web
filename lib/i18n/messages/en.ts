...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.new": "New",
    "sidebar.navigationScope": "Session scope",
    "sidebar.workspace": "Workspace",
    "sidebar.global": "Global",
    "sidebar.globalPlaceholder": "Global session navigation will be available here.",
    "sidebar.searchGlobalSessions": "Search sessions, projects, or paths…",
    "sidebar.clearGlobalSearch": "Clear global session search",
    "sidebar.history": "History",
    "sidebar.noHistory": "No history sessions",
    "sidebar.historyEmptyHint": "Completed sessions will appear here.",
    "sidebar.historyLoadError": "Session history is temporarily unavailable",
    "sidebar.completed": "Completed",
    "sidebar.cwdUnavailable": "cwd unavailable",
    "sidebar.running": "Running",
    "sidebar.runningStatusCompacting": "Compacting context",
    "sidebar.runningStatusExecuting": "Executing command",
    "sidebar.runningStatusGenerating": "Generating",
    "sidebar.runningStatusProcessing": "Processing / waiting",
    "sidebar.runningStatusUnknown": "Status unknown",
    "sidebar.runningLoading": "Loading running sessions…",
    "sidebar.runningLoadError": "Running status is temporarily unavailable",
    "sidebar.retry": "Retry",
    "sidebar.noRunning": "No sessions are running",
    "sidebar.noMatchingRunning": "No matching running sessions",
    "sidebar.noMatchingHistory": "No matching history sessions",
    "sidebar.noMatchingHistoryHint": "Try a title, project name, or cwd",
    "sidebar.loadEarlierSessions": "Load earlier sessions ({count})",
    "sidebar.queuedMessages": "{count} queued messages",
    ...
    "files.unavailable": "FileExplorer unavailable",
