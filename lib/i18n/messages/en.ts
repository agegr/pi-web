...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "export.title": "Session Export",
    "export.openSidebar": "Open sidebar",
    "export.search": "Search...",
    "export.filterDefault": "Default",
    "export.filterDefaultTitle": "Hide settings entries",
    "export.filterNoTools": "No-tools",
    "export.filterNoToolsTitle": "Default minus tool results",
    "export.filterUser": "User",
    "export.filterUserTitle": "Only user messages",
    "export.filterLabeled": "Labeled",
    "export.filterLabeledTitle": "Only labeled entries",
    "export.filterAll": "All",
    "export.filterAllTitle": "Show everything",
    "export.close": "Close",
    "export.resizeSidebar": "Resize session tree sidebar",
    "export.entries": "{visible} / {total} entries",
    "export.roleSkill": "skill",
    "export.roleUser": "user",
    "export.roleAssistant": "assistant",
    "export.abortedParenthetical": "(aborted)",
    "export.noText": "(no text)",
    "export.compactionTree": "[compaction: {count}k tokens]",
    "export.branchSummaryTree": "[branch summary]:",
    "export.modelTree": "[model: {model}]",
    "export.thinkingTree": "[thinking: {level}]",
    "export.moreLinesExpand": "... ({count} more lines, click to expand)",
    "export.moreLines": "... ({count} more lines)",
    "export.lines": "({count} lines)",
    "export.invalidArg": "[invalid arg]",
    "export.invalidContent": "[invalid content arg - expected string]",
    "export.copyLink": "Copy link to this message",
    "export.clickToExpand": "{name} (click to expand)",
    "export.thinking": "Thinking ...",
    "export.aborted": "Aborted",
    "export.error": "Error",
    "export.unknownError": "Unknown error",
    "export.cancelled": "(cancelled)",
    "export.exitCode": "(exit {code})",
    "export.switchedModel": "Switched to model",
    "export.compactionLabel": "[compaction]",
    "export.compactedFrom": "Compacted from {count} tokens",
    "export.branchSummary": "Branch Summary",
    "export.userMessages": "{count} user",
    "export.assistantMessages": "{count} assistant",
    "export.toolResults": "{count} tool results",
    "export.customMessages": "{count} custom",
    "export.compactions": "{count} compactions",
    "export.branchSummaries": "{count} branch summaries",
    "export.session": "Session",
    "export.unknown": "unknown",
    "export.helpHint": "T toggle thinking · O toggle tools",
    "export.toggleThinking": "Toggle thinking",
    "export.toggleThinkingTitle": "Toggle thinking (T)",
    "export.toggleTools": "Toggle tools",
    "export.toggleToolsTitle": "Toggle tools (O)",
    "export.downloadJson": "Download session as JSONL",
    "export.date": "Date",
    ...
    "export.cost": "Cost",
    "export.systemPrompt": "System Prompt",
    "export.availableTools": "Available Tools",
