...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.dictationError.aborted": "Dictation stopped",
    "chat.dictationError.audio-capture": "Microphone capture is unavailable",
    "chat.dictationError.network": "Speech recognition network error",
    "chat.dictationError.no-speech": "No speech detected",
    "chat.dictationError.not-allowed": "Microphone permission was denied",
    "chat.dictationError.service-not-allowed": "Speech recognition is unavailable",
    "chat.dictationError.unknown": "Dictation failed",
