...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.defaultDirectoryDescription": "Used by “Use default directory” in the project picker. Leave empty for a dated folder in your home directory. `{date}` becomes today’s YYYYMMDD.",
    "settings.defaultDirectoryResolved": "Opens {path}",
    "settings.browseDirectory": "Browse",
    "settings.resetDefaultDirectory": "Reset default directory",
