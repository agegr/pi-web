...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.pinnedSessions": "Enable pinned sessions",
    ...
    "pinnedSessions.label": "Pinned",
    "pinnedSessions.title": "Pinned sessions",
    "pinnedSessions.count": "{count} pinned",
    "pinnedSessions.running": "Running",
    "pinnedSessions.pinned": "Pinned",
    "pinnedSessions.current": "Current session",
    "pinnedSessions.empty": "No pinned sessions",
