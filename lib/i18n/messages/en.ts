...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "directoryPicker.noFoldersYet": "No folders yet",
    "directoryPicker.createFolder": "+ Create folder",
    "directoryPicker.cloneRepo": "Clone repo",
    "directoryPicker.newFolder": "+ New Folder",
    "directoryPicker.cloneButton": "Clone",
    "directoryPicker.cloning": "Cloning… {elapsed}",
    "directoryPicker.matchingFolders": "Matching folders:",
    "directoryPicker.createFolderPlaceholder": "e.g. my-project",
    "directoryPicker.cloneRepoPlaceholder": "https://github.com/user/repo.git",
    "directoryPicker.folderNameNoDot": "Folder names cannot start with a dot",
    "directoryPicker.createNewFolder": "Create a new folder",
    "directoryPicker.cloneGitRepo": "Clone a git repository",
