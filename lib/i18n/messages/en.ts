...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "directoryPicker.createDirectory": "Create directory",
    "directoryPicker.directoryName": "Directory name",
    "directoryPicker.directoryNamePlaceholder": "Enter a directory name",
    "directoryPicker.confirmAndSelect": "Create and select",
    "directoryPicker.confirm": "Create",
