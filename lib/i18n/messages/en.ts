...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.backgroundDescription": "Stored only in this browser. The 20 most recent images are kept.",
    "settings.backgroundChoose": "Choose image",
    "settings.backgroundSaving": "Saving…",
    "settings.backgroundDisable": "Disable",
    "settings.backgroundOpacity": "Image opacity",
    "settings.backgroundHistory": "Recent backgrounds",
    "settings.backgroundUse": "Use {name} as background",
    "settings.backgroundRemove": "Remove background",
    "settings.backgroundRemoveNamed": "Remove {name}",
