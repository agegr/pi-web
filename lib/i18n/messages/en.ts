...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "shutdown.start": "Shut down in 60s",
    "shutdown.confirmTitle": "Shut down in 60 seconds",
    "shutdown.confirmBody": "The computer will shut down 60 seconds after you confirm. You can cancel at any time during the countdown.",
    "shutdown.confirmOk": "Shut down",
    "shutdown.confirmCancel": "Cancel",
    "shutdown.cancel": "Cancel",
    "shutdown.remaining": "{seconds}s left",
    "shutdown.cancelling": "Cancelling…",
    "shutdown.aboutToShutdown": "Shutting down…",
    "shutdown.failed": "Shutdown command failed",
  },
};
