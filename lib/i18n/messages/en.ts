...
/** Pi Web built-in English locale plugin. */
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "auth.changePassword": "Change access password",
    "auth.saveAndRelogin": "Save and sign in again",
    "auth.logout": "Sign out",
    "auth.close": "Close",
    "auth.processing": "Processing...",
    "auth.login.title": "Sign in to Pi Web",
    "auth.login.description": "Enter your access password to continue to the workspace.",
    "auth.login.submit": "Sign in",
    "auth.setup.title": "Set up access protection",
    "auth.setup.description": "Use the one-time token from the server to set an access password.",
    "auth.setup.submit": "Set up",
    "auth.error.AUTH_INVALID_PARAMETERS": "The request parameters are invalid.",
    "auth.error.AUTH_PASSWORD_MISMATCH": "The passwords do not match.",
    "auth.error.AUTH_LOGIN_RATE_LIMITED": "Too many login attempts. Please try again later.",
    "auth.error.AUTH_SETUP_RATE_LIMITED": "Too many setup attempts. Please try again later.",
    "auth.error.AUTH_LOGIN_FAILED": "Sign-in failed. Please try again later.",
    "auth.error.AUTH_SETUP_TOKEN_INVALID": "The setup token is invalid.",
    "auth.error.AUTH_ALREADY_INITIALIZED": "Access protection is already initialized.",
    "auth.error.AUTH_PASSWORD_INVALID": "The password format is invalid.",
    "auth.error.AUTH_SETUP_FAILED": "Setup failed. Please try again later.",
    "auth.error.AUTH_NETWORK_ERROR": "A network error occurred. Please try again.",
    "auth.error.AUTH_PASSWORD_CHANGE_FAILED": "Password change failed. Please try again later.",
    "auth.error.AUTH_LOGOUT_FAILED": "Sign-out failed. Please try again later.",
