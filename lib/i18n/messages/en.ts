...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "web.openUrl": "Open web page",
    "web.newTab": "New web page",
    "web.address": "Web address",
    "web.addressPlaceholder": "Enter a URL, e.g. www.google.com",
    "web.go": "Go",
    "web.reload": "Reload page",
    ...
    "attach.reviewing": "Reviewing — click to continue this session",
    "attach.reviewingHint": "Continue this session. Its working directory is prepared first, so any branch this session belongs to is checked out.",
    "attach.attaching": "Preparing the working directory…",
    "attach.attached": "Active",
    "attach.attachedHint": "This session is active and owns its working directory.",
    "attach.reviewingChip": "Reviewing",
    "attach.reviewingChipHint": "Read-only. Nothing in this session affects your files until you continue it.",
    "attach.conflictBusy": "Another session is running here: {session}. Wait for it to finish, or continue reviewing.",
    "attach.failed": "Could not continue this session: {error}",
    "attach.detach": "Release working directory",
    "sidebar.new": "New",
    ...
    "chat.send": "Send",
    "chat.quotedSections": "Quoted sections",
    "chat.quoteCommentPlaceholder": "Add your question or comment…",
    "chat.moveQuoteUp": "Move quote up",
    "chat.moveQuoteDown": "Move quote down",
    ...
    "chat.replyInMain": "Reply in main",
    "chat.startingThread": "Starting thread: {title}",
    "chat.replyingInThread": "Replying in thread: {title}",
    "chat.threadEmpty": "Write the first message using the composer below.",
    "chat.threadLoadFailed": "Could not load this thread.",
    ...
    "i18n.quoteSelection": "Quote selection",
    "i18n.quoteSelectionTitle": "Add the selected text to your reply",
    "i18n.quoteResponse": "Quote response",
