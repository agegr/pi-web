...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "network.subtitle": "Configure server-side access to external model APIs.",
    "network.close": "Close network settings",
    "network.loading": "Loading network settings…",
    "network.effective": "Effective proxy",
    "network.source": "Source",
    "network.source.environment": "Environment variables",
    "network.source.saved": "Page override",
    "network.source.windows-system": "Windows system proxy",
    "network.source.direct": "Direct connection",
    "network.environmentLocked": "The proxy is managed by environment variables and cannot be overridden here.",
    "network.windowsDetection": "Windows detection",
    "network.windowsAvailable": "Windows Internet Settings were detected for the current user.",
    "network.windowsUnavailable": "Windows Internet Settings are unavailable.",
    "network.wpadDetected": "Windows automatic proxy detection (WPAD) is enabled.",
    "network.pacWarning": "Only PAC/WPAD is configured. Pi Web shows this for diagnosis but cannot evaluate PAC rules; enter a fixed proxy below.",
    "network.override": "Page override",
    "network.enableOverride": "Use this proxy configuration",
    "network.httpProxy": "HTTP proxy",
    "network.httpsProxy": "HTTPS proxy",
    "network.test": "Test proxy",
    "network.testing": "Testing…",
    "network.testSuccess": "Connection reached the provider",
    "network.save": "Save and apply",
    "network.saving": "Saving…",
    "network.saved": "Proxy settings saved and applied.",
    "network.clear": "Use automatic settings",
    "network.cleared": "Page override cleared; automatic settings are active.",
