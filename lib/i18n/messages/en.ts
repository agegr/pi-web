...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.undoFirstTurn": "Undo and edit",
    "chat.undoFirstTurnHint": "Discard this stopped first turn and restore its text and images to the composer, without keeping a history branch.",
    "chat.undoFirstTurnDraftBusy": "Clear or save your current draft before undoing the first turn.",
    "chat.undoFirstTurnFailed": "Unable to undo the first turn. The original input has been restored to the composer.",
