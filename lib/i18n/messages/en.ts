...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "pair.connectPhone": "Connect Phone",
    "pair.title": "Open on your phone",
    "pair.scanWithPhone": "Scan with your phone's camera to open this app.",
    "pair.urlLabel": "Or open this URL",
    "pair.passwordLabel": "Password (only needed once)",
    "pair.passwordHint": "Your phone will remember it for 30 days after first sign-in.",
    "pair.copy": "Copy",
    "pair.copied": "Copied",
    "pair.loading": "Loading…",
    "pair.error": "Could not load connection info",
    "pair.regenerate": "Regenerate",
    "pair.regenerateEnvLocked": "Password is set via PI_WEB_PASSWORD env; restart with a new value to change it.",
    "pair.notSet": "No password configured (server is open to anyone on the network).",
    "pair.noHostnameWarning": "Server has no bound hostname; QR encodes loopback only.",
    "pair.usernameLabel": "Username",
  },
};
