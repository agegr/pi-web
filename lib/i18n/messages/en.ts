...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.askTitle": "Question",
    "chat.askMinimize": "Minimize question",
    "chat.askExpand": "Expand",
    "chat.askShowRaw": "Show terminal view",
    "chat.askShowContext": "Show context",
    "chat.askHideContext": "Hide context",
    "chat.askFreeformPlaceholder": "Something else...",
    "chat.askCommentPlaceholder": "Add a comment (optional)",
    "chat.askSkip": "Skip",
    "chat.askSubmit": "Submit",
    "chat.askSubmitCount": "Submit {count}",
    "chat.askPending": "Waiting for an answer",
    "chat.askAnswered": "Answered",
    "chat.askCancelled": "Dismissed",
    "chat.askFreeformAnswer": "Answer",
    "chat.askComment": "Comment",
