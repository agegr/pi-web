...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.sessionTitle": "Session title",
    "settings.sessionTitleDescription": "Choose the model that names sessions. Thinking is minimized when the model supports it.",
    "settings.sessionTitleModel": "Title model",
    "settings.sessionTitleModelInherit": "Use the session's own model (default)",
