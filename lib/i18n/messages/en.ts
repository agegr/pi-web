...
export const enLocale: LocalePlugin = {
  ...
  label: "English",
  messages: {
    "workspace.configureModel": "Configure models",
    "settings.modelsEmptyTitle": "Connect your first model",
    "settings.modelsEmptyDescription": "Add a provider using an API key, subscription sign-in, or a custom compatible endpoint.",
    "settings.skillsEmptyTitle": "Add skills to your workspace",
    "settings.skillsEmptyDescription": "Find and install skills that give the AI focused instructions for specific tasks.",
    "settings.pluginSource": "Source",
    "settings.pluginExamples": "Examples",
    "settings.pluginsEmpty": "No plugins yet",
    "workspace.newConversation": "New conversation",
    "workspace.conversations": "Conversations",
    "workspace.actions": "Workspace actions",
    "workspace.welcomeDescription": "Choose a project and connect a model to start working with Pi.",
    "workspace.startConversation": "Start a conversation in your project",
    "workspace.conversationDescription": "Explore, write, and understand your code with AI.",
    "common.ok": "OK",
