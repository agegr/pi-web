...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.researchMode": "Research mode",
    "settings.researchModeDescription": "Select any term in the conversation to get an instant AI explanation, dig deeper recursively, follow the concept chain, and hover explained terms to review them.",
    "settings.researchModeToggle": "Enable research mode",
    "research.webSearch": "Ground this explanation in web search results",
    "research.webFailed": "search unreachable — answered from model knowledge",
    "research.exportMindmap": "Export as an interactive mind map (HTML — just double-click; includes a .mm download for XMind/FreeMind)",
    "research.exportAnki": "Export as an Anki import file (.csv — use File → Import inside Anki; Excel will show raw HTML)",
    ...
    "research.explainAction": "Explain",
    "research.explainHint": "Select any term to keep digging",
    "research.depthBrief": "Brief",
    "research.depthStandard": "Standard",
    "research.depthDeep": "Deep",
    "research.close": "Close",
    "research.retry": "Retry",
    "research.unknownError": "Something went wrong",
    "research.chainTitle": "Concept chain",
    "research.chainEmpty": "Select any term in the conversation to start a research chain.",
    "research.export": "Export as Markdown",
    "research.clear": "Clear the whole chain",
    "research.clearConfirm": "Clear the whole concept chain? This cannot be undone.",
    "research.remove": "Remove this term and everything below it",
    "research.thinking": "Thinking",
    "research.chainStats": "{terms} terms · {chains} chains",
    "research.followupQ": "Q",
    "research.followupPlaceholder": "Ask a follow-up about this term…",
    "research.followupSend": "Send follow-up",
    "research.followupBadge": "{n} asked",
    "research.hoverOpen": "Open the full explanation",
  },
};
