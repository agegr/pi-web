...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.searchSessionsPlaceholder": "Search message contents…",
    "sidebar.searchingSessions": "Searching conversations…",
    "sidebar.noMatchingSessions": "No conversations matched",
    "sidebar.searchScopeAll": "All projects",
    "sidebar.searchScopeProject": "Only {project}",
    "sidebar.searchIncludeTools": "Include tool output",
    "sidebar.searchMinLength": "Type at least {count} characters",
