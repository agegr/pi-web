...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.headersHelp": "Forwards the configured value, overriding the same-named header (case-insensitive). Rows with an empty value do not participate in overriding — they are placeholders to fill in.",
    "models.providerHeadersHelp": "Added to every request from this provider, overriding the same-named header (case-insensitive). Rows with an empty value do not participate in overriding — they are placeholders to fill in.",
    "models.headerNamePlaceholder": "Header name",
    "models.headerValuePlaceholder": "Value",
