...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.syncSummary": "Upstream: {total} models · {added} to add · {stale} no longer offered",
    "models.syncRemoveStale": "Also remove {count} models no longer offered upstream",
