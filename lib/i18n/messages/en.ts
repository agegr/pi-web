...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "auth.loginTitle": "Sign in to Pi Web",
    "auth.loginSubtitle":
      "Enter your credentials to access the console and sessions",
    "auth.title": "Welcome to Pi Web",
    "auth.description":
      "Enter your credentials to access the console and sessions",
    ...
    "auth.invalidPassword": "Incorrect password. Please try again.",
    "auth.networkError": "Authentication failed. Please check your network.",
    "auth.welcomeBack": "Welcome Back",
    "auth.secureSession": "Password-protected access session",
