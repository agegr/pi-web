...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.visibilityManage": "Manage visible models",
    "models.visibilityTitle": "Model visibility",
    "models.visibilityDescription": "Choose which models appear in the model selector. Saves the enabledModels list in ~/.pi/agent/settings.json.",
    "models.visibilitySelectAll": "Select all",
    "models.visibilityShown": "{shown} of {total} shown",
    "models.visibilityAdvancedNotice": "The current enabledModels scope uses globs or thinking-level pins. Saving replaces it with the explicit selection below.",
    "models.visibilityEmptySelection": "Keep at least one model visible.",
