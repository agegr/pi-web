...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.catalogEmpty": "No models in the provider catalog",
    "models.toggleHint": "Toggle whether this model appears in the model selector",
    "models.backfillNotice": "New provider(s) kept fully visible via provider/*: {providers}",
    "models.refreshCatalog": "Refresh models",
    "models.refreshCatalogHint": "Re-fetch the remote model catalog (pi.dev). pi-web normally only reads the local cache.",
    "models.refreshing": "Refreshing…",
    "models.imageTag": "IMG",
    "models.supportsImage": "Supports image input",
    "models.reasoningTag": "REASON",
    "models.supportsReasoning": "Supports extended reasoning",
    "models.whitelistActive": "Allowlist on: {count} pattern(s)",
    "models.whitelistInactive": "Allowlist off — all models visible",
    "models.masterToggleHint": "Toggle every model of this provider",
    ...
    "i18n.deleteProviderConfirm": "Delete the custom provider {provider}? Its model definitions and stored API key are removed — this cannot be undone.",
    "i18n.deleteModelConfirm": "Remove model {model}?",
    "i18n.removeOAuthConfirm": "Remove the {provider} connection? This deletes the stored sign-in credentials — its models become unavailable until you sign in again.",
    "i18n.removeKeyConfirm": "Remove the {provider} API key? Its models become unavailable until you enter a key again.",
