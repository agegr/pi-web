...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.autoTitle": "Session titles",
    "settings.autoTitleDescription": "Automatically generate a session title with the session's model after its first completed run. Sessions you name yourself are never renamed.",
    "settings.autoTitleLabel": "Generate titles automatically",
