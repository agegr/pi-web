...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sideChat.label": "Side chat",
    "sideChat.title": "Side chat",
    "sideChat.opening": "Opening side chat...",
    "sideChat.close": "Close side chat",
    "sideChat.inherited": "{count} messages inherited",
    "sideChat.ephemeral": "not saved, discarded on close",
    "sideChat.placeholder": "Ask something without derailing the main task",
    "sideChat.send": "Send",
    "sideChat.stop": "Stop",
    "sideChat.bringBack": "Bring to main chat",
    "sideChat.broughtBack": "Added to composer",
    "sideChat.bringBackHint": "Put the latest answer into the main composer",
    "sideChat.reclaimed": "This side chat expired; sending will open a fresh one",
    "sideChat.revived": "The previous side chat expired, so a fresh one was opened and your question was resent (earlier side-chat turns are not kept)",
