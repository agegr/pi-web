...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.thinkingStyle": "Thinking block style",
    "settings.thinkingStyleDescription": "How thinking blocks (the model's internal reasoning) are displayed.",
    "settings.thinkingCard": "Card with icon",
    "settings.thinkingMinimal": "Minimal",
    "settings.diffWrap": "Diff line wrapping",
    "settings.diffWrapDescription": "Choose whether long lines in the diff viewer wrap or scroll horizontally.",
    "settings.diffWrapOn": "Wrap",
    "settings.diffWrapOff": "No wrap",
