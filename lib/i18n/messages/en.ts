...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.index": "Session Index",
    "settings.indexDescription": "Builds a fast SQLite index for session search, navigation, and loading. Disabling falls back to scanning JSONL files directly. Requires a server restart after changing.",
    "settings.indexEnabled": "Enable SQLite session index",
    "settings.retry": "Retry",
    "settings.retryDescription": "When the model returns an error, Pi automatically retries the request with exponential backoff. Disable to surface errors immediately.",
    "settings.retryEnabled": "Auto-retry on error",
    "settings.retryMaxRetries": "Max retries",
    "settings.retryMaxRetriesDescription": "Maximum number of automatic retry attempts. Default: 3.",
    "settings.retryBaseDelay": "Base delay (ms)",
    "settings.retryBaseDelayDescription": "Initial delay before the first retry. Each subsequent retry doubles this delay. Default: 2000ms.",
    "settings.minimap": "Chat Minimap",
    "settings.minimapDescription": "Configure the minimap that shows message positions in the chat.",
    "settings.minimapMaxNodes": "Max nodes (0 = all)",
    "settings.minimapMaxNodesHint": "0 shows all messages. Higher values limit the number of nodes displayed. Content scrolls vertically when it overflows.",
    ...
    "chatMinimap.toolCount": "{count} tools",
    "i18n.close": "Close",
    "i18n.copy": "Copy",
    "i18n.copied": "Copied",
    "i18n.cancel": "Cancel",
