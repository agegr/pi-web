...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "trust.mcpNotLoaded": "Project MCP servers are not started because this project is not trusted.",
    "mcp.scopeGlobal": "Global",
    "mcp.scopeProject": "Project",
    "mcp.liveTools": "Live tools",
    "mcp.liveCount": "{count} MCP tool(s) available in this session",
    "mcp.addServer": "Add server",
    "mcp.empty": "No MCP servers configured",
    "mcp.emptyHint": "Add a server to expose its tools to the agent.",
    "mcp.selectHint": "Select a server to edit it.",
    "mcp.fieldName": "Name",
    ...
    "mcp.fieldEnv": "Environment (KEY=value, one per line)",
    "mcp.fieldUrl": "Server URL",
    "mcp.securityNote": "stdio servers run as local processes with your user's permissions. Global servers always start; project servers start only in trusted projects.",
    "mcp.saved": "Saved. Reload the session to apply.",
    "mcp.removed": "Removed. Reload the session to apply.",
    "mcp.reloadSession": "Reload session",
    "mcp.errorCommandRequired": "A command is required for a stdio server.",
    "mcp.errorUrlRequired": "A URL is required for an HTTP server.",
    "mcp.errorEnvFormat": "Invalid environment line: {line}",
