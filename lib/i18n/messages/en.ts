...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "session.viewChat": "Chat",
    "session.viewTrajectory": "Trajectory",
    ...
    "chat.steerNowPlaceholder": "Steer now…",
    "chat.followUpPlaceholder": "Queue a follow-up…",
    ...
    "trajectory.empty": "No trajectory data yet. Ask Pi something to start recording.",
    "trajectory.error.noSidecar": "Trajectory is not available for sessions created before this feature.",
    "trajectory.error.unavailable": "Trajectory is not available for this session.",
    "trajectory.error.loadFailed": "Failed to load trajectory.",
    "trajectory.metric.requests": "Requests",
    "trajectory.metric.tools": "Tools",
    "trajectory.metric.tokens": "Tokens",
    "trajectory.metric.active": "Active",
    "trajectory.metric.compactions": "Compactions",
    "trajectory.metric.retries": "Retries",
    "trajectory.timeline.title": "Timing overview",
    "trajectory.timeline.hint": "Click a span to inspect",
    "trajectory.lane.model": "Model",
    "trajectory.lane.tool": "Tools",
    "trajectory.lane.subagent": "Subagents",
    "trajectory.lane.compaction": "Compaction",
    "trajectory.spanRunning": "running",
    "trajectory.searchPlaceholder": "Search events...",
    "trajectory.searchLabel": "Search trajectory events",
    "trajectory.filterType": "Filter by type",
    "trajectory.filterStatus": "Filter by status",
    "trajectory.col.seq": "#",
    "trajectory.col.turn": "Turn",
    "trajectory.col.type": "Type",
    "trajectory.col.event": "Event",
    "trajectory.col.time": "Time",
    "trajectory.col.status": "Status",
    "trajectory.expand": "Expand subagent trajectory",
    "trajectory.collapse": "Collapse subagent trajectory",
    "trajectory.noMatches": "No events match the current filters.",
    "trajectory.childRequests": "{count} requests",
    "trajectory.childTools": "{count} tools",
    "trajectory.childTokens": "{count} tokens",
    "trajectory.childActive": "{duration} active",
    "trajectory.childMore": "+{count} more records",
    "trajectory.kind.all": "all",
    "trajectory.kind.request": "request",
    "trajectory.kind.tool": "tool",
    "trajectory.kind.retry": "retry",
    "trajectory.kind.compaction": "compaction",
    "trajectory.kind.subagent": "subagent",
    "trajectory.kind.turn": "turn",
    "trajectory.kind.error": "error",
    "trajectory.kind.other": "other",
    "trajectory.status.all": "all",
    "trajectory.status.running": "running",
    "trajectory.status.complete": "complete",
    "trajectory.status.aborted": "aborted",
    "trajectory.status.error": "error",
    "trajectory.inspectEmpty": "Select a record to inspect",
    ...
    "trajectory.field.duration": "Duration",
    "trajectory.field.turn": "Turn",
    "trajectory.field.request": "Request",
    "trajectory.field.step": "Step",
    "trajectory.field.childSession": "Child session",
    "trajectory.field.summary": "Summary",
    "trajectory.durationRunning": "running",
    "trajectory.privacyPending": "Full input and output for this record is stored locally in the session trajectory sidecar. It may contain file paths, tool arguments and command output.",
    "trajectory.privacySummary": "Inputs and outputs are hidden in summary mode.",
    "trajectory.confirmLoad": "Confirm and load",
    "trajectory.cancel": "Cancel",
    "trajectory.loadDetails": "Load full details",
    "trajectory.closeInspector": "Close inspector",
    "trajectory.recordLabel": "Record {kind}",
  },
};
