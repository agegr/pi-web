...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.hidePseudoProjects": "Hide unmerged worktree projects",
    "sidebar.hidePseudoProjectsTitle": "Hide project rows for removed worktree directories that could not be merged back into their repository. Turn off to show them again.",
    "sidebar.pseudoProjectsHidden": "{count} hidden",
    "sidebar.pseudoProjectsVisible": "{count} visible",
    ...
    "sidebar.explorerEmpty": "Pin or select a project to browse its files",
    ...
    "chat.attachFromCamera": "Take photo",
    "chat.attachFromGallery": "Choose from library",
