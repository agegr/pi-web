...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.hideProjectTitle": "Hide this project from the list. Its sessions are kept.",
    "sidebar.hiddenProjects": "Hidden projects ({count})",
    "sidebar.showProject": "Show this project in the list again",
