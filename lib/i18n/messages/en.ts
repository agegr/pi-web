...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.openConversations": "Open conversations",
    ...
    "chat.voiceTranscribing": "Transcribing with SenseVoice…",
    "chat.voiceDownloading": "Downloading SenseVoice… {percent}%",
    "chat.voiceLangAuto": "Auto Chinese + English",
    "chat.voiceLangZh": "Chinese",
    "chat.voiceLangEn": "English",
