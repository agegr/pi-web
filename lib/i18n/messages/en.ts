...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "trajectory.error": "Failed to load trajectory",
    "trajectory.close": "Close",
    "trajectory.empty": "This session has no events yet",
    "trajectory.loadEarlier": "Load earlier",
    "trajectory.loadingEarlier": "Loading...",
    "trajectory.overview": "Time overview",
    "trajectory.legendWait": "first token wait",
    "trajectory.legendDecode": "decode",
    "trajectory.legendTool": "tool",
    "trajectory.turn": "Turn {index}",
    ...
    "trajectory.customMessage": "injected message",
    "trajectory.other": "other",
    "trajectory.toolCalls": "{count} tool calls",
    "trajectory.partialTurn": "partially loaded",
    "trajectory.branchSummaryCounts": "{turns} turns / {rows} rows",
    "trajectory.timingCoverage": "timing {timed}/{total}",
    "trajectory.timingMissing": "TTFT and output speed are only available for requests made after timing capture was enabled",
    "trajectory.startedAt": "started",
    "trajectory.duration": "duration",
    "trajectory.modelName": "model",
    "trajectory.stopReason": "stop reason",
    "trajectory.tokens": "Tokens",
    "trajectory.tokenBreakdown": "in {input} / out {output} / cache read {cacheRead}",
    "trajectory.cost": "cost",
    "trajectory.ttft": "TTFT",
    "trajectory.decode": "decode",
    "trajectory.toolCallId": "tool call id",
    "trajectory.args": "arguments",
    ...
    "session.timingSection": "Timing",
    "session.modelTime": "Model Time",
    "session.toolTime": "Tool Call Time",
    "session.ttft": "First Token (Avg, TTFT)",
    "session.tps": "Output Speed (TPS)",
