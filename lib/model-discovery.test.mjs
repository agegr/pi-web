...
test("never forwards credentials to link-local or private targets", () => {
  for (const target of [
  ...
  assert.throws(
    () => assertSafeDiscoveryTarget(new URL("http://10.0.0.8/v1/models"), { headers: { Authorization: "Bearer x" } }),
    /private|loopback|local/i,
