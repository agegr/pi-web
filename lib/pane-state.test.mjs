...
test("visiblePaneCapacity floors the area and clamps to at least one pane", () => {
  assert.equal(visiblePaneCapacity(1280, MIN_PANE_WIDTH), 3);
  assert.equal(visiblePaneCapacity(1080, MIN_PANE_WIDTH), 3);
  assert.equal(visiblePaneCapacity(900, MIN_PANE_WIDTH), 2);
  assert.equal(visiblePaneCapacity(300, MIN_PANE_WIDTH), 1, "floor(300/360)=0 clamps up to 1");
...
test("visiblePaneCapacity is the single source of truth paneWidth sizes by", () => {
  // floor(1080/360) = 3: exactly 3 panes fit, a 4th overflows.
  assert.equal(paneWidth(3, 1080, MIN_PANE_WIDTH), 1080 / visiblePaneCapacity(1080, MIN_PANE_WIDTH));
