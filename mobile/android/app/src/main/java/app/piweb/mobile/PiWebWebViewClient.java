...
public class PiWebWebViewClient extends BridgeWebViewClient {
    ...
    private InputStream injectRuntime(InputStream plain) {
        try {
            Object injector = bridge.getClass().getDeclaredMethod("getJSInjector").invoke(bridge);
            return (InputStream) injector.getClass()
                .getMethod("getInjectedStream", InputStream.class)
                .invoke(injector, plain);
        } catch (Exception e) {
            return null;
        }
    }
