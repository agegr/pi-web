...
- **Project file tools**: browse and upload files, edit text files in place, create, rename, and delete files and folders, download files, extract and create ZIP archives, inspect Git diffs, and preview source, Markdown, images, audio, PDFs, and DOCX files with automatic refresh.
