...
Making process thinking and tool calling to simple, with upgrade agegr/pi-web v0.8.7.

<img width="1717" height="907" alt="image" src="https://github.com/user-attachments/assets/e8babd5b-fc25-41f7-9ec4-113950450afb" />
<img width="1718" height="907" alt="image" src="https://github.com/user-attachments/assets/2b3ca121-c560-4161-86b9-20d59a4e66fb" />
<img width="1718" height="910" alt="image" src="https://github.com/user-attachments/assets/1fe3b092-ba1e-4bde-b45f-16295e51f0e4" />
<img width="1907" height="916" alt="image" src="https://github.com/user-attachments/assets/9b4e43b6-82f4-4a50-af26-2137b703b3fd" />
...
npm install 
```
## Ekstract file remake pi-web 0.8.7 
```bash
tar -xzf <location_file_download>/pi-web-process-ui.tar.gz -C /tmp 
cp -R /tmp/pi-web-process-ui/. .
rm -rf .next
...
npm run lint
node --experimental-strip-types --test lib/*.test.mjs components/*.test.mjs hooks/*.test.mjs
```
## running demo

```bash
npm run dev # without compile and build
```
--------------------------------------------------
```bash
npm run build # with compile and build
npm link
pi-web
```
====================================================================
...
>When you build with npm start here to clear

```bash 
lsof -ti:30141 | xargs kill  
npm uninstall -g @agegr/pi-web
```
## Check clean

```bash 
which pi-web              # must clean
npm ls -g --depth=0       
```
>When you just npm run dev start here to clear
## clear folder Repo

```bash 
rm -rf pi-web  #(~/pi-web)   
rm -rf /tmp/pi-web-process-ui
```
