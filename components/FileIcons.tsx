...
// CSS url() 不走 fetch,layout 的运行时 patch 覆盖不到——这里必须显式带前缀。
// NEXT_PUBLIC_BASE_PATH 由 next.config.ts 在 build 时内联(根部署为空字符串)。
const CATPPUCCIN_ICONS_ROOT = `${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/icons/catppuccin`;
