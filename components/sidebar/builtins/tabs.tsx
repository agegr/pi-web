 ...
 */
import { IconBranchOutline16, IconFolderOpen16, IconNewChatOutline16, IconThinkOutline16 } from "../ui-primitives"
import type { Context } from '../context-types'
import { allLeaves, isAgentTabId, type SidebarState } from '../state'
import { t } from '../locales'
import { openSidebarFile } from '../intercept'
import { NativeFilesTab } from '../NativeFilesTab'
import { lazyChunkComponent } from '../lazy-chunk'
import { GitView } from '../GitView'
import { DiffTab } from '../DiffTab'
import { SubagentView } from '../SubagentView'
import { consumeSidechatSeed, SideChatView, sidechatThreadIdOf } from '../SideChatView'
import { api } from '../api'
import { BrowserView } from '../BrowserView'
import { IconTerminalOutline16, IconDiffOutline16, IconGlobeOutline16 } from '../icons'
import { TERMINAL_FONT_SIZE_MAX, TERMINAL_FONT_SIZE_MIN } from '../prefs-shared'
import type { ComponentType } from 'react'
import type { SessionScope } from '../api'
import type { SidebarStore } from '../state'
import type { TabDescriptor } from '../service'
  ...
  return [
    {
      ...
      single: true,
      component: ({ ctx, scope }) => {
        // Delegate to the native pi-web FileExplorer + FileViewer so the
        // chunk-loaded CodeMirror editor is never required in embedded mode.
        const nativeOpenFile = ctx.get('nativeOpenFile') as
          | ((filePath: string, fileName: string, options?: { sourceSessionId?: string | null }) => void)
          | undefined
        return (
          <NativeFilesTab
            cwd={scope.cwd ?? ''}
            sessionId={scope.sessionId}
            onOpenFile={nativeOpenFile}
          />
        )
      },
    },
