...
function getNodeColor(msg: AgentMessage | Partial<AgentMessage>): {
  ...
  if (msg.role === "user") {
    return { bg: "rgba(37,99,235,0.22)", border: "rgba(37,99,235,0.9)" }; // blue
  }
  return { bg: "rgba(234,88,12,0.2)", border: "rgba(234,88,12,0.85)" }; // orange
}
...
export function ChatMinimap({
  ...
  const handleMinimapLeave = useCallback(() => {
  ...
  return (
    <div
      ...
      onMouseEnter={handleMinimapEnter}
