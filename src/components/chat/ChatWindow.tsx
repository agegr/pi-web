      ...
      <div className="relative flex flex-1 overflow-hidden">
        <div ref={scrollContainerRef} className="flex-1 overflow-y-auto pt-4 [scrollbar-width:none]">
          <div className="mx-auto max-w-[820px] px-4">
            ...
            {(() => {
              const toolResultsMap = new Map<string, import("@/lib/shared/types").ToolResultMessage>();
              for (const msg of messages) {
                if (msg.role === "toolResult") {
                  toolResultsMap.set((msg as import("@/lib/shared/types").ToolResultMessage).toolCallId, msg as import("@/lib/shared/types").ToolResultMessage);
                }
              }
              let lastUserIdx = -1;
              ...
              return messages.map((msg, idx) => {
                ...
                const view = (
                  <MessageView
                    ...
                    prevTimestamp={idx > 0 ? (messages[idx - 1] as import("@/lib/shared/types").AgentMessage & { timestamp?: number }).timestamp : undefined}
                  />
                );
