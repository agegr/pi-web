...
import { FileViewer } from "@/components/session/FileViewer";
import { TabBar, type Tab } from "@/components/session/TabBar";
...
import type { SessionInfo, SessionTreeNode } from "@/lib/shared/types";
